...
const troopInfo = {
    ...
    BRUNGILDA: {
        attack: 10,
        health: 70,
        ability: "In combat: Deals extra 10 DMG to enemy adjacent troops."
    },
    ULGAR: {
        attack: 20,
        health: 80,
...
const troopAbilitiesTranslations = {
    ...
    BRUNGILDA: {
        en: "In combat: Deals extra 10 DMG to enemy adjacent troops.",
        es: "En combate: Inflige 10 de daño extra a las tropas enemigas adyacentes."
    },
    ULGAR: {
